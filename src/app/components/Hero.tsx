...
export function Hero() {
  ...
  const HomeView = () => (
    <div className="h-full w-full flex flex-col relative overflow-hidden group">
      {/* Background Gradient */}
      <div className="absolute inset-0 z-0 bg-gradient-to-br from-[#1b2a4a] via-[#273a5a] to-[#1b2a4a]">
        ...
        {[
          ...
          >
            ...
            <div className="mt-2 md:mt-3 h-[6px] rounded-full bg-gray-100 overflow-hidden">
              <div
                className="h-full bg-gradient-to-r from-[#059669] to-[#1b2a4a]"
                style={{ width: `${70 + i * 7}%` }}
              />
            </div>
          </button>
  ...
  const AboutView = () => (
    <div className="h-full flex flex-col px-4 py-3 md:px-10 md:py-10">
      ...
      <div className="mt-auto pt-2 md:pt-3">
        <button
          onClick={() => navigate("contact")}
          className="w-full inline-flex items-center justify-center gap-2 rounded-full bg-[#1b2a4a] text-white py-3 text-xs md:text-sm font-bold hover:bg-slate-800 transition-colors"
        >
