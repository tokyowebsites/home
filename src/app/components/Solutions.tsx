      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
                ...
                >
                  <div className="relative z-10 flex flex-col items-start h-full">
                    <div className={`w-12 h-12 md:w-16 md:h-16 rounded-2xl flex items-center justify-center mb-6 shadow-xl transition-all duration-500 group-hover:scale-110 group-hover:rotate-3 ${
                      ...
                      item.color === 'emerald' ? 'bg-blue-500 text-white' :
                  ...
                  <div className={`absolute -bottom-6 -right-6 w-24 h-24 rounded-full blur-3xl opacity-10 transition-opacity group-hover:opacity-20 ${
                    ...
                    item.color === 'emerald' ? 'bg-blue-500' :
        ...
        <div className="mt-8 mb-16 relative -mx-4 px-4 sm:mx-0 sm:px-0">
          <motion.div
            ...
            viewport={{ once: true }}
            className="p-6 md:p-12 rounded-[2rem] md:rounded-[2.5rem] bg-gradient-to-br from-gray-800/60 to-gray-900/60 border border-blue-500/30 backdrop-blur-md"
          >
             <div className="flex flex-col gap-8 md:gap-12">
                <div className="flex flex-col md:flex-row items-center justify-between gap-4">
                   <div className="text-center md:text-left">
                      ...
                      <div className="inline-flex items-center gap-2 text-blue-400 text-[10px] md:text-xs font-black uppercase tracking-widest bg-blue-500/10 px-3 py-1.5 rounded-full border border-blue-500/20">
                ...
                <div className="grid grid-cols-4 gap-2 md:gap-12">
                   {steps.map((step, idx) => (
                      <div key={idx} className="flex flex-col items-center md:items-start text-center md:text-left group/step">
                         <div className="w-8 h-8 md:w-10 md:h-10 rounded-lg md:rounded-xl bg-gray-900 border border-gray-700 flex items-center justify-center text-white mb-2 md:mb-4 group-hover/step:bg-blue-600 group-hover/step:border-blue-500 transition-all duration-300">
                            <step.icon size={14} className="md:size-[18px]" />
                         </div>
                         <div className="text-[7px] md:text-[10px] font-black text-blue-400 uppercase tracking-widest mb-0.5 md:mb-1">{step.number}</div>
                         <div className="text-[9px] md:text-xs font-black text-white uppercase tracking-tight leading-tight">{step.title}</div>
                         <div className="text-[7px] md:text-[9px] font-black text-gray-500 uppercase tracking-widest mt-0.5 leading-none">{step.titleEn}</div>
                      </div>
                   ))}
                </div>
             </div>
